        ...
        option = {
            ...
            legend: {
                data: ['in Use Pallet', 'in Use Tb', 'Free Tb', 'Broken Tb']
            },
            toolbox: {
                show: true,
                feature: {
            ...
            series: [
...

                {
                    ...
                    data: (function () {
                        ...
                        var len = 0;
                        while (len < 15) {
                            res.push((Math.random() * 10 + 20).toFixed(1));
                            len++;
                        }
                        return res;
                    })()
        ...
        setInterval(function () {
            ...
            data2.shift();
            data2.push((Math.random() * 10 + 20).toFixed(1));
            data3.shift();
            data3.push((Math.random() * 1 + 5).toFixed(1));
